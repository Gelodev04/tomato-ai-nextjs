...
const Footer = () => {
  ...
  <div className="max-w-7xl mx-auto">
    ...
    <div className="mt-10 md:text-[20px] text-[16px] ">
      <p>
        상호명: 토마토AI(주) ㅣ대표: 홍길동 ㅣ이메일: support@tomato-ai.kr
        ㅣ 전화: 02-123-1234 ㅣ사업자등록번호: 123-45-67890 <br /> 주소: 서울시
        강남구 테헤란로 123, 7층 ㅣ 고객센터 운영시간: 평일 10:00 – 18:00
        (점심시간 12:00 – 13:00)
      </p>
    </div>
    <p className="mt-7 md:text-[16px] text-[14px] ">
      © 2025 Tomato AI, Inc. All rights reserved.
    </p>
  </div>
</footer>
